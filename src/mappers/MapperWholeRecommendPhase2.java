...
public class MapperWholeRecommendPhase2 extends
...
//				}
				...
				String[] userAndCount = userCountList[0]
				...
				IntWritable userID = new IntWritable(
						Integer.parseInt(userAndCount[0]));
				for (String eachFriend : friendList) {
					context.write(userID, new Text(eachFriend
							+ Protocols.USER_WEIGHT + userAndCount[1]));
				}
